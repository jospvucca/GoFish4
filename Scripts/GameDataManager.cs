...
namespace GoFish
{
    ...
    public class GameDataManager
    {
        ...
        {
            protectedData.SetCurrentTurnPlayer(player.PlayerId);
        }
        ...
        public Player GetNextTurnPlayer()
        {
            ...
            {
                Debug.LogError("Logic error in GameDataManager :: GetNextTurnPlayer()!");
                return null;
            }
        }
        ...
        //DODAT VRLO VJEROJATNO JOS ZA ODABIR PLAYERA SET I GET
        ///////////triba dodat ovde
